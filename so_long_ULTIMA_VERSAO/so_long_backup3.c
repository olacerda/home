...
/*   Updated: 2025/09/19 14:10:44 by olacerda         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
int	callback(int code, void *arg)
{
	...
	// if (code == 100 && all->map->map[all->play->pixel_line / 64][((all->play->pixel_column + 10) / 64)] != '1')
	// 	all->play->pixel_column += 10;    // direita
	// if (code == 97 && all->map->map[all->play->pixel_line / 64][((all->play->pixel_column - 10) / 64)] != '1')
	// 	all->play->pixel_column -= 10;    // esquerda
	// if (code == 119 && all->map->map[((all->play->pixel_line - 10) / 64)][all->play->pixel_column / 64] != '1')
	// 	all->play->pixel_line -= 10;    // cima
	// if (code == 115 && all->map->map[((all->play->pixel_line + 10) / 64)][all->play->pixel_column / 64] != '1')
	// 	all->play->pixel_line += 10;    
	
	// // direita
	// if ((code == 100 && all->map->map[all->play->pixel_line / 64][(all->play->pixel_column + speed + 10 - 1) / 64] != '1'))
	// 	// (code == 100 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column + 64 + 10 - 1) / 64] != '1'))
	// 	all->play->pixel_column += speed;

	// // esquerda
	// if ((code == 97 && all->map->map[all->play->pixel_line / 64][(all->play->pixel_column - 1) / 64] != '1'))
	// 	// (code == 97 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column - 10 - 1) / 64] != '1'))
	// 	all->play->pixel_column -= speed;

	// // cima
	// if ((code == 119 && all->map->map[(all->play->pixel_line - 1) / 64][all->play->pixel_column / 64] != '1'))
	// 	// (code == 119 && all->map->map[(all->play->pixel_line - 10 - 1 + 64) / 64][all->play->pixel_column / 64] != '1'))
	// 	all->play->pixel_line -= speed;

	// // baixo
	// if ((code == 115 && all->map->map[(all->play->pixel_line + speed + 10 - 1) / 64][all->play->pixel_column / 64] != '1'))
	// 	// (code == 115 && all->map->map[(all->play->pixel_line + 64 + 10 - 1) / 64][all->play->pixel_column / 64] != '1'))
	// 	all->play->pixel_line += speed;

	// // direita
	// if ((code == 100 && all->map->map[(all->play->pixel_line + 63) / 64][(all->play->pixel_column + 63 + speed) / 64] != '1') && 
	// 	(code == 100 && all->map->map[all->play->pixel_line / 64][(all->play->pixel_column + 63 + speed) / 64] != '1'))
	// 	// (code == 100 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column + 64 + 10 - 1) / 64] != '1'))
	// 	all->play->pixel_column += speed;

	// // esquerda
	// if ((code == 97 && all->map->map[(all->play->pixel_line) / 64][(all->play->pixel_column - speed) / 64] != '1'))
	// 	// (code == 97 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column - 10 - 1) / 64] != '1'))
	// 	all->play->pixel_column -= speed;

	// // cima
	// if ((code == 119 && all->map->map[(all->play->pixel_line - speed) / 64][all->play->pixel_column / 64] != '1'))
	// 	// (code == 119 && all->map->map[(all->play->pixel_line - 10 - 1 + 64) / 64][all->play->pixel_column / 64] != '1'))
	// 	all->play->pixel_line -= speed;

	// // baixo
	// if ((code == 115 && all->map->map[(all->play->pixel_line + 63 + speed) / 64][(all->play->pixel_column + 63) / 64] != '1') &&
	// 		(code == 115 && all->map->map[(all->play->pixel_line + speed) / 64][all->play->pixel_column / 64] != '1'))
	// 	// (code == 115 && all->map->map[(all->play->pixel_line + 64 + 10 - 1) / 64][all->play->pixel_column / 64] != '1'))
	// 	all->play->pixel_line += speed;
...
// -------------------------------
	...
	if ((code == 100 && all->map->map[(all->play->pixel_line + 63) / 64][(all->play->pixel_column + 63 + speed) / 64] != '1') && 
		...
		// (code == 100 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column + 64 + 10 - 1) / 64] != '1'))
		all->play->pixel_column += speed;
	else if ((code == 100 && all->map->map[(all->play->pixel_line + 63) / 64][(all->play->pixel_column + 63 + 1) / 64] != '1') && 
		(code == 100 && all->map->map[all->play->pixel_line / 64][(all->play->pixel_column + 63 + 1) / 64] != '1'))
		all->play->pixel_column += 1;

	// esquerda
	if ((code == 97 && all->map->map[(all->play->pixel_line) / 64][(all->play->pixel_column - speed) / 64] != '1') && 
		(code == 97 && all->map->map[(all->play->pixel_line + 63) / 64][(all->play->pixel_column - speed) / 64] != '1'))
		// (code == 97 && all->map->map[(all->play->pixel_line + 64) / 64][(all->play->pixel_column - 10 - 1) / 64] != '1'))
		all->play->pixel_column -= speed;
	else if ((code == 97 && all->map->map[(all->play->pixel_line) / 64][(all->play->pixel_column - 1) / 64] != '1') && 
		(code == 97 && all->map->map[(all->play->pixel_line + 63) / 64][(all->play->pixel_column - 1) / 64] != '1'))
		all->play->pixel_column -= 1;
	// cima
	if ((code == 119 && all->map->map[(all->play->pixel_line - speed) / 64][all->play->pixel_column / 64] != '1') &&
		(code == 119 && all->map->map[(all->play->pixel_line - speed) / 64][(all->play->pixel_column + 63) / 64] != '1'))
		// (code == 119 && all->map->map[(all->play->pixel_line - 10 - 1 + 64) / 64][all->play->pixel_column / 64] != '1'))
		all->play->pixel_line -= speed;
	else if ((code == 119 && all->map->map[(all->play->pixel_line - 1) / 64][all->play->pixel_column / 64] != '1') &&
		(code == 119 && all->map->map[(all->play->pixel_line - 1) / 64][(all->play->pixel_column + 63) / 64] != '1'))
		all->play->pixel_line -= 1;
	// baixo
	if ((code == 115 && all->map->map[(all->play->pixel_line + 63 + speed) / 64][(all->play->pixel_column + 63) / 64] != '1') &&
			(code == 115 && all->map->map[(all->play->pixel_line + 63 + speed) / 64][all->play->pixel_column / 64] != '1'))
		// (code == 115 && all->map->map[(all->play->pixel_line + 64 + 10 - 1) / 64][all->play->pixel_column / 64] != '1'))
		all->play->pixel_line += speed;
	else if ((code == 115 && all->map->map[(all->play->pixel_line + 63 + 1) / 64][(all->play->pixel_column + 63) / 64] != '1') &&
			(code == 115 && all->map->map[(all->play->pixel_line + 63 + 1) / 64][all->play->pixel_column / 64] != '1'))
		all->play->pixel_line += 1;
//-----------------------------
