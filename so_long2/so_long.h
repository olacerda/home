...
/*   Updated: 2025/10/06 17:07:26 by olacerda         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
typedef struct s_all_images
{
	...
	t_sheet *red_letters_sheet;
	t_sheet *terminal_sheet;
	t_image *grass;
	t_image *wall;
	t_image *player;
	t_image *collectable;
...
void			mesage_cat_letters(t_all *all, int *line, char (*writed)[28], char *reference);
