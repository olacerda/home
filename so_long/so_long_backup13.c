...
/*   Updated: 2025/09/26 06:40:22 by otlacerd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_backup5.h"
...
int game_loop(void *arg)
{
	...
	{
		void *window2;
		window2 = mlx_new_window(all->mlx, 320, 320, "TERMINAL");
		mlx_string_put(all->mlx, window2, 100, 100, 16711680, "Isso e um teste");
...
void	general_settings(t_all *all)
{
	...
	all->game->real_elements = "EC10PRXITYO";
	if (all->images)
