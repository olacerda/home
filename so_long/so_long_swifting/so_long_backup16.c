...
/*   Updated: 2025/09/27 03:21:00 by olacerda         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void	check_letters_colected(t_all *all, char	element, int line, int column)
{
	...
	if (element == 'R' || element == 'X' || element == 'I' || element == 'T')
	{
		...
		while (index < 4)
		{
			...
			if ((all->play->letter_colected[index] != letters[index]))
				return ;
...
void	update_game(t_all *all)
{
	...
	{
		if ((check_hitbox(all, 'C') == 1) && (all->states->full_colectables == 0))
		{
			write(1, "\a", 1);
			all->play->colected++;
		...
		else if ((check_hitbox(all, 'R') == 1) && all->play->R == 0)
		{
			write(1, "\a", 1);
			// static int flag = 1;
			// if (flag == 1)
		...
		else if ((check_hitbox(all, 'X') == 1) && all->play->X == 0)
		{
			write(1, "\a", 1);
			// static int flag = 1;
		...
		else if ((check_hitbox(all, 'I') == 1) && all->play->I == 0)
		{
			write(1, "\a", 1);
			// static int flag = 1;
			// if (flag == 1)
		...
		else if ((check_hitbox(all, 'T') == 1) && all->play->T == 0)
		{
			write(1, "\a", 1);
			// static int flag = 1;
			// if (flag == 1)
