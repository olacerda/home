...
/*   Updated: 2025/10/11 19:30:23 by olacerda         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void			check_message(t_all *all, int *line, char (*writed)[28], int size);
...
void			message_able_desabe_ub_count(t_all *all, int *line, char (*writed)[28]);
void			message_able_desable_ub(t_all *all, int *line, char (*writed)[28]);
